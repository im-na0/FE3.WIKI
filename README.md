...
1. 출퇴근 기록 페이지
   - 출퇴근 기록 리스트
     ㄴ 나의 출퇴근 기록 및 내가 속한 팀원들의 출퇴근 기록 확인, 날짜 순으로 정렬 가능
   - 출퇴근 기록 캘린더
   ㄴ 나의 출퇴근 기록을 일자별로 출력
   <!-- 여기까지 미정님 구현 사항 -->
1. 위키 페이지
...
|        **메인 페이지**         |        **로그인/회원가입 페이지**         |
| :----------------------------: | :---------------------------------------: |
| ![메인 페이지](public/images/) | <img src="public/images/signin.png" width="400px" height="300px"> <img src="public/images/signup.png" width="400px" height="300px">|

|        **정보 수정 페이지**         |        **직원정보 페이지**         |
| :---------------------------------: | :--------------------------------: |
| <img src="public/images/userInfo.png" height="400px"> | ![직원정보 페이지](public/images/) |

|        **위키 페이지**         |                 **프로젝트 페이지**                  |
| :----------------------------: | :--------------------------------------------------: |
| ![위키 페이지](public/images/) | ![프로젝트 페이지](public/images/project-detail.png) |
...
1. 출퇴근 타이머
   ![timer-btnonoff](public/images/timer-btnonoff.mov)
   - 오늘 날짜 및 현재 시간 표시
...
1. 출퇴근 기록 페이지
   ![worktime-listcalendar](public/images/worktime-listcalendar.mov)
   - 출퇴근 기록 리스트: 로그인 상태일때만 타이머 모달창 내에서 접근할 수 있습니다.  
     ...
     ![worktime-teamlist](public/images/worktime-teamlist.mov)
